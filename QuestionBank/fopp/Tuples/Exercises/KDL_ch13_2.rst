.. activecode:: KDL_ch13_2
   :author: Kaelyn Leake
   :difficulty: 1.0526360762
   :basecourse: fopp
   :chapter: Tuples
   ...
   :autograde: unittest
   :language: python
   :pct_on_first: 0.5961538462
   :total_students_attempting: 52
   :num_students_correct: 47.0
   :mean_clicks_to_correct: 1.8936170213
   ...
   class myTests(TestCaseGui):
       ...
       def testOne(self):
           ...
           self.assertIn('enumerate', self.getEditorText(), 'enumerate in the code')
           self.assertIn('def list_link', self.getEditorText(), 'function is defined')
