.. mchoice:: irma_Ch1_3
        ...
        :feedback_c: Oh no. The value of b doesn't need since it is being divided.
        ...
        :mean_clicks_to_correct: 2.5454545455
        ...
        Which line of code will you need to change in order to succesfully divide `b` by something that doesn't have the value of 0?