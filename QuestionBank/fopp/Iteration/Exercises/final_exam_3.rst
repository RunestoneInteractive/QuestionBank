.. activecode:: final_exam_3
   :author: Irma Ravkic
   :difficulty: 1.1400918991
   :basecourse: fopp
   :chapter: Iteration
   ...
   :language: python
   :autograde: unittest
   :pct_on_first: 0.1803278689
   :total_students_attempting: 61
   :num_students_correct: 37.0
   :mean_clicks_to_correct: 3.3783783784
   ...
   class myTests(TestCaseGui):
       def testOne(self):
           self.assertEqual(sum_of_lengths, 46 , 'Checking the value of sum_of_lengths.')
       def testTwo(self):
           self.assertEqual(average_length, 5.75 , 'Checking the value of average_length.')
   myTests().main()