.. actex:: quiz_2_length_of_name_jcomes
   :author: Jonny Comes
   :difficulty: 1.0392681838
   :basecourse: fopp
   ...
   characters in that name. If the user enters Dr. Danielson, the program should tell them there are 13 characters (including the period and the space).
   ~~~~
