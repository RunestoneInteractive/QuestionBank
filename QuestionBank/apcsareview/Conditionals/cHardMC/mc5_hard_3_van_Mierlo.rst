.. mchoice:: mc5_hard_3_van_Mierlo
   ...
   :feedback_c: This expression would be true whenever x is > 10 or y < 20.  The (x > 15 && x < 18) will be true for x = 16 or 17 which is included in (x > 10).
