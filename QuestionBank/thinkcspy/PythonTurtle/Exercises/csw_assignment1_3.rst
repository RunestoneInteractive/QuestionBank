.. activecode:: csw_assignment1_3
   ...
   concentric circles (a "bullseye" pattern). Your job is to write
   the body of the loop that draws the circles. For an additional
   challenge (but no extra credit) draw three bullseyes at different
