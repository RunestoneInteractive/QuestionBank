.. activecode:: 1306_hw2_f19_q6
   ...
   Write a program to play the "guess the number" game. Your program should use the ``random``
   module to pick a magic (random) number between 1 and 100 and the user will try to 
   ...
   Hint: You can print using a variable while using the function input() so display information while seeking input in the online Python interpreter. 
   
   Example:
   
   show_message = “What is your name?”
   
   x = input(show_message)
