.. actex:: minerva_ex_2_7
   ...
   Write a Python program that assigns the principal amount of Minerva loan $4950 to
   variable `P`, assign to `n` the value 12, and assign to `r` the interest
   rate of 6% (0.06).  Then have the program prompt the user for the number of years,
