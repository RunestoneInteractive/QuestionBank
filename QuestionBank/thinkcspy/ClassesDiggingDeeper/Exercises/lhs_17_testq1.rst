.. activecode:: lhs_17_testq1
    ...
    **Step 2.**  Also create the following methods:
    ...
    ``getReal`` should **return** the the real value of the number. In the case of (3 + 4i), the method
    should return 3.
    
    ``getImag`` should **return** the the imaginary value of the number. In the case of (3 + 4i),
    the method should return 4.
    
    ``magnitude`` should **return** the magnitude of the number.  The magnitude is square_root(r*r + i*i).
    The magnitude of the number (3 + 4i) is 5.
