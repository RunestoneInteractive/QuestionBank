.. dragndrop:: ch10_17_match_2
    ...
    :subchapter: topic-7-8-summary
    :topics: Unit7-ArrayList/topic-7-8-summary
    :from_source: T
    ...
    :pct_on_first: 0.7437626433
    :total_students_attempting: 1483
    :num_students_correct: 1360.0
    :mean_clicks_to_correct: 1.5419117647
